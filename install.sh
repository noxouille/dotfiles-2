...
echo "Apps: ranger htop scrot w3m atool unzip neovim mupdf mplayer qutebrowser transmission-cli"
pacman -S --noconfirm xorg-server xorg-xinit xorg-xsetroot bash-completion gcc make pkg-config libx11 libxft libxinerama ttf-ubuntu-font-family ranger htop scrot w3m atool unzip python-pip clang neovim mupdf mplayer qutebrowser transmission-cli &> /dev/null
